      ...
      <div className="lg:hidden sticky top-0 z-50 bg-background border-b px-4 py-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">{statusCounts.total} jobs</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="text-sm">Estimated vs actual hours for completed jobs</CardDescription>
                </CardHeader>
                <CardContent>
                  <ChartContainer
                    config={{
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="text-sm">Job completion and average hours by team member</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                      ...
                      <div className="text-xs lg:text-sm text-orange-700 dark:text-orange-400">Avg. Job Duration</div>
                    </div>
            ...
            <TabsContent value="grid">
              ...
              <div className="lg:hidden space-y-4">
                {filteredJobs.map((job) => {
                  ...
                  return (
                    <Card key={job.id} className={`${isOverdue ? "border-red-300 bg-red-50 dark:bg-red-900/20" : ""}`}>
