...
<div class="wrap">
    ...
    <div id="jct-admin-container">
        <div class="jct-header">
            ...
            <div class="jct-header-actions">
                <button id="jct-export-jobs" class="button">
                    <span class="dashicons dashicons-download"></span>
                    <?php _e('Export', 'job-card-tracking'); ?>
                </button>
    ...
    <div id="jct-quick-export-modal" class="jct-modal" style="display: none;">
        <div class="jct-modal-content">
            <div class="jct-modal-header">
                <h2><?php _e('Quick Export', 'job-card-tracking'); ?></h2>
                <span class="jct-close">&times;</span>
            </div>
            <div class="jct-modal-body">
                <p><?php _e('Export current filtered jobs:', 'job-card-tracking'); ?></p>
                <div class="jct-export-formats">
                    <button class="button button-primary jct-quick-export" data-format="csv">
                        <span class="dashicons dashicons-media-spreadsheet"></span>
                        <?php _e('Export as CSV', 'job-card-tracking'); ?>
                    </button>
                    <button class="button jct-quick-export" data-format="json">
                        <span class="dashicons dashicons-media-code"></span>
                        <?php _e('Export as JSON', 'job-card-tracking'); ?>
                    </button>
                </div>
            </div>
        </div>
