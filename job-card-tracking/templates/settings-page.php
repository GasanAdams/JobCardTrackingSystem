...
<div class="wrap">
    ...
    <form method="post" action="">
        ...
        <h2><?php _e('Display Options', 'job-card-tracking'); ?></h2>
        <table class="form-table">
            <tr>
                <th scope="row"><?php _e('Theme Settings', 'job-card-tracking'); ?></th>
                <td>
                    <fieldset>
                        <p><?php _e('Users can toggle between light and dark themes using the theme toggle button.', 'job-card-tracking'); ?></p>
                        <p><?php _e('Theme preference is saved in browser localStorage.', 'job-card-tracking'); ?></p>
                    </fieldset>
                </td>
            </tr>
        </table>
