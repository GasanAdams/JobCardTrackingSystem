...
<div id="jct-frontend-container" class="jct-container" data-view="<?php echo esc_attr($atts['view']); ?>">
    ...
    <!-- View Toggle -->
    <div class="jct-view-toggle">
        <button id="jct-grid-view" class="jct-view-btn active" data-view="grid">
            <span class="dashicons dashicons-grid-view"></span>
            <?php _e('Grid', 'job-card-tracking'); ?>
        </button>
        <button id="jct-list-view" class="jct-view-btn" data-view="list">
            <span class="dashicons dashicons-list-view"></span>
            <?php _e('List', 'job-card-tracking'); ?>
        </button>
    </div>
